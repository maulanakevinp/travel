...
@section('content')
<div class="container">
    <h1 class="font-weight-bold d-inline-block">Upload your Images <span id="counter"></span></h1>
    <a href="{{ route('gallery.index') }}" class="btn btn-secondary float-right">{{ __('Back') }}</a>
